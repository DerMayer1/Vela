...
const variantClasses = {
  ...
  primary:
    'border border-primary-hover/80 bg-[linear-gradient(135deg,_rgb(var(--color-primary)),_rgb(var(--color-primary-hover)))] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.2),0_18px_32px_rgba(28,92,255,0.28)] hover:-translate-y-0.5 hover:text-white hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_24px_40px_rgba(28,92,255,0.32)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/32 focus-visible:ring-offset-2 focus-visible:ring-offset-surface',
  secondary:
